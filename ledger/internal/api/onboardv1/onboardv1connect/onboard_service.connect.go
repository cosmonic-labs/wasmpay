...
import (
	...
	context "context"
	errors "errors"
	onboardv1 "github.com/cosmonic-labs/wasmpay/ledger/internal/api/onboardv1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	OnboardServiceName = "api.onboard.v1.OnboardService"
)
...
const (
	...
	OnboardServiceGetBankProcedure = "/api.onboard.v1.OnboardService/GetBank"
	// OnboardServiceListBanksProcedure is the fully-qualified name of the OnboardService's ListBanks
	// RPC.
	OnboardServiceListBanksProcedure = "/api.onboard.v1.OnboardService/ListBanks"
	// OnboardServiceCreateBankProcedure is the fully-qualified name of the OnboardService's CreateBank
	// RPC.
	OnboardServiceCreateBankProcedure = "/api.onboard.v1.OnboardService/CreateBank"
	// OnboardServiceDeleteBankProcedure is the fully-qualified name of the OnboardService's DeleteBank
	// RPC.
	OnboardServiceDeleteBankProcedure = "/api.onboard.v1.OnboardService/DeleteBank"
	// OnboardServiceGetCustomerProcedure is the fully-qualified name of the OnboardService's
	// GetCustomer RPC.
	OnboardServiceGetCustomerProcedure = "/api.onboard.v1.OnboardService/GetCustomer"
	// OnboardServiceListCustomersProcedure is the fully-qualified name of the OnboardService's
	// ListCustomers RPC.
	OnboardServiceListCustomersProcedure = "/api.onboard.v1.OnboardService/ListCustomers"
	// OnboardServiceCreateCustomerProcedure is the fully-qualified name of the OnboardService's
	// CreateCustomer RPC.
	OnboardServiceCreateCustomerProcedure = "/api.onboard.v1.OnboardService/CreateCustomer"
	// OnboardServiceDeleteCustomerProcedure is the fully-qualified name of the OnboardService's
	// DeleteCustomer RPC.
	OnboardServiceDeleteCustomerProcedure = "/api.onboard.v1.OnboardService/DeleteCustomer"
)

// OnboardServiceClient is a client for the api.onboard.v1.OnboardService service.
...
// NewOnboardServiceClient constructs a client for the api.onboard.v1.OnboardService service. By
...
func NewOnboardServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) OnboardServiceClient {
	...
	onboardServiceMethods := onboardv1.File_api_onboard_v1_onboard_service_proto.Services().ByName("OnboardService").Methods()
...
// GetBank calls api.onboard.v1.OnboardService.GetBank.
...
// ListBanks calls api.onboard.v1.OnboardService.ListBanks.
...
// CreateBank calls api.onboard.v1.OnboardService.CreateBank.
...
// DeleteBank calls api.onboard.v1.OnboardService.DeleteBank.
...
// GetCustomer calls api.onboard.v1.OnboardService.GetCustomer.
...
// ListCustomers calls api.onboard.v1.OnboardService.ListCustomers.
...
// CreateCustomer calls api.onboard.v1.OnboardService.CreateCustomer.
...
// DeleteCustomer calls api.onboard.v1.OnboardService.DeleteCustomer.
...
// OnboardServiceHandler is an implementation of the api.onboard.v1.OnboardService service.
...
func NewOnboardServiceHandler(svc OnboardServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/api.onboard.v1.OnboardService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedOnboardServiceHandler) GetBank(context.Context, *connect.Request[onboardv1.GetBankRequest]) (*connect.Response[onboardv1.GetBankResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("api.onboard.v1.OnboardService.GetBank is not implemented"))
}
...
func (UnimplementedOnboardServiceHandler) ListBanks(context.Context, *connect.Request[onboardv1.ListBanksRequest]) (*connect.Response[onboardv1.ListBanksResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("api.onboard.v1.OnboardService.ListBanks is not implemented"))
}
...
func (UnimplementedOnboardServiceHandler) CreateBank(context.Context, *connect.Request[onboardv1.CreateBankRequest]) (*connect.Response[onboardv1.CreateBankResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("api.onboard.v1.OnboardService.CreateBank is not implemented"))
}
...
func (UnimplementedOnboardServiceHandler) DeleteBank(context.Context, *connect.Request[onboardv1.DeleteBankRequest]) (*connect.Response[onboardv1.DeleteBankResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("api.onboard.v1.OnboardService.DeleteBank is not implemented"))
}
...
func (UnimplementedOnboardServiceHandler) GetCustomer(context.Context, *connect.Request[onboardv1.GetCustomerRequest]) (*connect.Response[onboardv1.GetCustomerResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("api.onboard.v1.OnboardService.GetCustomer is not implemented"))
}
...
func (UnimplementedOnboardServiceHandler) ListCustomers(context.Context, *connect.Request[onboardv1.ListCustomersRequest]) (*connect.Response[onboardv1.ListCustomersResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("api.onboard.v1.OnboardService.ListCustomers is not implemented"))
}
...
func (UnimplementedOnboardServiceHandler) CreateCustomer(context.Context, *connect.Request[onboardv1.CreateCustomerRequest]) (*connect.Response[onboardv1.CreateCustomerResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("api.onboard.v1.OnboardService.CreateCustomer is not implemented"))
}
...
func (UnimplementedOnboardServiceHandler) DeleteCustomer(context.Context, *connect.Request[onboardv1.DeleteCustomerRequest]) (*connect.Response[onboardv1.DeleteCustomerResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("api.onboard.v1.OnboardService.DeleteCustomer is not implemented"))
}
