...
import (
	...
	context "context"
	errors "errors"
	transferv1 "github.com/cosmonic-labs/wasmpay/ledger/internal/rpc/transferv1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	TransferServiceName = "proto.ledger.transfer.v1.TransferService"
)
...
const (
	...
	// RPC.
	TransferServiceTransferProcedure = "/proto.ledger.transfer.v1.TransferService/Transfer"
)

// TransferServiceClient is a client for the proto.ledger.transfer.v1.TransferService service.
...
// NewTransferServiceClient constructs a client for the proto.ledger.transfer.v1.TransferService
...
func NewTransferServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) TransferServiceClient {
	...
	transferServiceMethods := transferv1.File_proto_ledger_transfer_v1_transfer_service_proto.Services().ByName("TransferService").Methods()
...
// Transfer calls proto.ledger.transfer.v1.TransferService.Transfer.
...
// TransferServiceHandler is an implementation of the proto.ledger.transfer.v1.TransferService
// service.
...
func NewTransferServiceHandler(svc TransferServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/proto.ledger.transfer.v1.TransferService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedTransferServiceHandler) Transfer(context.Context, *connect.Request[transferv1.TransferRequest]) (*connect.Response[transferv1.TransferResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("proto.ledger.transfer.v1.TransferService.Transfer is not implemented"))
}
